 ...
 <table class="table table-bordered table-hover">
    ...
    <td><input type='checkbox' class='checkboxes' name="checkboxArray[]" value="<?php echo $post_id;?>"></td>
                      ...
                      echo "<td><img width='50' height='50' src='../images/$post_image'></td>";
                        ...
                        echo "<td><a onclick='_edite(event)' class='btn btn-primary' href='?source=edit_post&p_id=$post_id'>Editer</a></td>";
                        ...
                        echo "<td><a onclick='_desap(event)' class='btn btn-danger' href='posts.php?desapprouve=$post_id'>Désapprouver</a></td>";
                           ...
                           <form action="" method="POST">
                             ...
                             <?php echo " <td> <a onclick='_delete(event)' ><input class='btn btn-danger'  name='delete' type='submit' value='Supprimer'</a></td>"; ?>
                           </form>
 <?php

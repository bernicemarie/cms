    ...
    <div class="col-lg-4 col-md-6">
        <div class="panel panel-yellow">
            ...
            <a href="">
                ...
                $post_status_count=graphcountuser('posts','post_status','Approuve');

                $post_status_desap_count=graphcountuser('posts','post_status','Desapprouve');
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php 
             $element_text=['Posts Approuvés','Posts desapprouvés','Comments', 'Categories'];
             $element_count=[ $post_status_count,$post_status_desap_count,$comments_count,$categories_count];
             for($i=0;$i<4;$i++){

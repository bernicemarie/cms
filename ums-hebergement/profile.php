 ...
 <?php  
  ...
  ?>
   <?php 
if (isset($_SESSION['user_compte'])) {
    $user_compte=$_SESSION['user_compte'];

 $query_profile=" SELECT * FROM users WHERE compte='$user_compte'";
     ...
     role='$role',
     compte='$compte',
     password='$password' WHERE compte='$user_compte'";
     $result=mysqli_query($connect,$query);
      if (!$result) {
      die('Modification impossible');
   }
      header("Location:index.php? Modification réalisée!");
       }
       }
 ?>
            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="panel panel-info">
                                            <div class="panel-heading ui-draggable-handle">
                                                <h3 class="panel-title"><strong> <?php echo  $_SESSION['user_compte'] ?> modifie son profile</strong></h3>
                  ...
                  <div class="col-md-8">  
                      ...
                      <div class="col-lg-8">
                         <input value="<?php if(isset($nom)) echo $nom;?>" name="nom" type="text" class=" form-control" required />
                      </div>
                    </div>
                     <div class="form-group ">
...
<div class="row">
                        <div class="col-md-12">
                           ...
                           <div class="modal-footer">
                              ...
                              <input type="submit" name="editer_profile" value="Modifier" class="btn btn-info">
